...
filenames = [data_dir+'/'+file+'.txt' for file in files]

test_size = 9112
dev_size = 8381
train_size = 67426
split = [train_size, dev_size, test_size]


train_file = data_dir + '/train' + train_type + '.txt'
dev_file = data_dir + '/dev.txt'
test_file = data_dir + '/test.txt'
vec_file =  '/media/wenjh/Ubuntu 16.0/Downloads/glove.6B/glove.6B.300d.txt'
...
print("vocab_size: ",vocab_size, "user_vocab_size: ", user_vocab_size, "prod_vocab_size: ", prod_vocab_size)
print('----------------------------------------------------')
# print(x_train[:10])
...
with sess.as_default():
    for i in range(epoch):
        ...
        for j in range(0, len(x_train_shuffle), batch_size):
            ...
            sys.stdout.write('\repoch:{}, batch:{}/{}, loss:{}'.format(i,j,len(x_train_shuffle),loss))
            sys.stdout.flush()
